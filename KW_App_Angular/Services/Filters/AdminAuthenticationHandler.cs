...
namespace KW_App_Angular.Services.Filters
{
    public class AdminAuthenticationHandler : AuthenticationHandler<AdminAuthenticationOptions>
    {
        ...
        private readonly IdentityDefaultModel _identityDefaultModel;
        ...
        public AdminAuthenticationHandler(
            ...
            IOptions<IdentityDefaultModel> identityDefaultModel

            ) : base(options, logger, encoder, clock)
        {
            _userManager = userManager;
            _appSettings = appSettings.Value;
            _identityDefaultModel = identityDefaultModel.Value;
            _provider = provider;
        ...
        protected override Task HandleChallengeAsync(AuthenticationProperties properties)
        {
            ...
            Response.Redirect(_identityDefaultModel.AccessDeniedPath);
